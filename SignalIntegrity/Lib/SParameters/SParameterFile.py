...
class SParameterFile(SParameters):
    ...
    def __init__(self,name,Z0=None,parameterType='S'):
        """Constructor
        ...
        @note Normally 'S' is specified as the desired result type, and if a Z- or Y-
        parameter file is read, it is converted to s-parameters.  If None is specified, the
        network parameters remain in the format read from the file.
        @note If the reference impedance of the Touchstone 1.0 file read is not the reference
