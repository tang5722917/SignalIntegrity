...
class PreferencesDialog(PropertiesDialog):
    def __init__(self, parent,preferences):
        ...
        self.tryRestoreLowFrequencyPoints=CalculationPropertyTrueFalseButton(self.propertyListFrame,'try to restore low frequency points (experimental)',None,self.onUpdatePreferences,preferences,'Calculation.TryRestoreLowFrequencyPoints')
